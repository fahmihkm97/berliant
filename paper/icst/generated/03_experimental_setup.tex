...
This scenario is specifically useful for evaluating stochastic screening robustness.
...
The purpose is robustness characterization rather than post-holdout parameter optimization.
...
All Python development commands are executed through the project's \texttt{uv} environment.
